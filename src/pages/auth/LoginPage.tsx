    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #fff5f7 0%, #ffe8ed 50%, #ffe0e8 100%)' }}>
      ...
      <div className="relative w-full max-w-md z-10">
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-gray-500 text-sm">欢迎回来，享受二次元时光</p>
        </div>
        ...
        <div className="relative card p-6 animate-slide-up">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <div className="relative flex items-center bg-white/80 rounded-xl border border-[#ff6b8a]/20 group-focus-within:border-[#ff6b8a]/50 transition-all duration-300">
                  <svg className="w-5 h-5 ml-3 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-3 bg-transparent text-gray-800 placeholder-gray-300 focus:outline-none text-sm"
              ...
              <div className="relative group">
                <div className="relative flex items-center bg-white/80 rounded-xl border border-[#ff6b8a]/20 group-focus-within:border-[#ff6b8a]/50 transition-all duration-300">
                  ...
                  <input
                    ...
                    className="w-28 px-3 py-3 bg-transparent text-gray-800 placeholder-gray-300 focus:outline-none text-sm"
                    placeholder="验证码"
                    maxLength={6}
                  />
                  <button
                    ...
                    className="mr-2 px-3 py-1.5 text-xs font-medium rounded-lg bg-gradient-to-r from-[#ff6b8a] to-[#ff8fa3] text-white hover:shadow-lg hover:shadow-[#ff6b8a]/25 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
                  >
          ...
          <div className="relative mt-6 pt-4 border-t border-[#ff6b8a]/10 text-center">
            <p className="text-sm text-gray-500">
              还没有账号？{' '}
              <Link to="/register" className="text-[#ff6b8a] hover:text-[#ff5070] font-medium transition-colors">
                立即注册
              </Link>
            </p>
          </div>
